...
class CarriersController extends VoyagerBaseController
{
    ...
    {   
        ...
        $requestNew = $request;                         // Making float product price.
        ...
        // Clear out any relations in Products Pivot $table.
    ...
    public function create(Request $request)
    {
        ...
        $categoriesForProduct = collect([]); // Assoc. with Update method below. Tp see all checked product's categories on update.
    ...
    public function store(Request $request)
    {
        ...
        $requestNew = $request; // Making float Carriers price.
        $requestNew['price'] = $request->price * 100;
